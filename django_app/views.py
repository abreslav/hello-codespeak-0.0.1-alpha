...
def db_demo(request):
    """
    View to render the DB demo page with Demo records and handle adding new records.
    """
    start_time = time.time()
    ...
    # Handle POST request to add new demo record
    if request.method == 'POST':
        ...
        if name and description:
            ...
            messages.success(request, 'Demo record added successfully!')
            return redirect('db_demo')
        else:
    ...
    # Render the template
    response = render(request, 'demo.html', {'demos': demos})
